...
export excel using "C:\Users\Guan\OneDrive\DHS\MEASURE UHC DATA\RAW DATA\Recode VII\external\Original\varlist_hspt_full.xlsx", sheet("full") firstrow(var) replace
...
export excel using "C:\Users\Guan\OneDrive\DHS\MEASURE UHC DATA\RAW DATA\Recode VII\external\Original\varlist_hspt.xlsx", sheet("label_only") firstrow(var) replace
