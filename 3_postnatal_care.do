...
****************************** 
	...
	*c_pnc_eff: mother AND child in first 24h by skilled health worker
	...
	gen c_pnc_any = .
		...
		replace c_pnc_any = . if inlist(m63,998) | inlist(m67,399,998) | inlist(m71,399,998) | inlist(m75,399,998) | m62 == 8 | m66 == 8 | m70 == 8 | m74 == 8
	...
	gen c_pnc_eff = .
		...
		replace c_pnc_eff = . if inlist(m63,299,998) | inlist(m67,299,998) | inlist(m71,299,998) | inlist(m75,299,998) | m62 == 8 | m66 == 8 | m70 == 8 | m74 == 8
	}
	...
	if inlist(name,"Afghanistan2015") {
		...
		replace c_pnc_eff = 1 if (((inrange(m71,100,124) | m71 == 201 | m71 ==199 ) & inrange(m72,11,13)) & ((inrange(m51,100,124) | m51 == 201| m51 == 199) & inrange(m52,11,13))) 
		replace c_pnc_eff = . if inlist(m71,299,998)| inlist(m51,998)| m72 == 8 | m52 == 8
	}
