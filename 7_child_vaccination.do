...
*c_dpt1	child			Child received DPT1/Pentavalent 1 vaccination	
		...
		if inlist(name,"Albania2017") {
			replace c_dpt1  = 0 if h1 == 1
			replace c_dpt1  = 1 if (h51 ==1 | h51 ==2 | h51 ==3) 
		}
*c_dpt2	child			Child received DPT2/Pentavalent2 vaccination				
		...
		if inlist(name,"Albania2017") {
			replace c_dpt2  = 0 if h1 == 1
			replace c_dpt2  = 1 if (h52 ==1 | h52 ==2 | h52 ==3) 
		}
*c_dpt3	child			Child received DPT3/Pentavalent3 vaccination				
		...
		if inlist(name,"Albania2017") {
			replace c_dpt3  = 0 if h1 == 1
			replace c_dpt3  = 1 if (h53 ==1 | h53 ==2 | h53 ==3)  
		}
