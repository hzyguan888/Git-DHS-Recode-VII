...
mdesc w_mammogram //identify the case where there is no mamogram info
...
*tag the micro-data accordingly for w_mammogram reference period
replace w_mammogram_ref  = "2yr" if miss_m ! = 1 

if inlist(name,"DominicanRepublic1996","DominicanRepublic1999","DominicanRepublic2002","DominicanRepublic2007","Nicaragua1998","Nicaragua2001") {
replace w_mammogram_ref  = "1yr" if country_year=="`y'"
}
if inlist(name, "Colombia2005","Colombia201","Colombia2015") {
replace w_mammogram_ref = "5yr" if country_year=="`y'"
}
if inlist(name,"Honduras2005","Honduras2011") {
replace w_mammogram_ref = "ever" if country_year=="`y'"
}
...
*tag the micro-data accordingly for w_mammogram_ref
replace w_mammogram_age = "40-49" if miss_m ! = 1 

if inlist(name,"Peru2013","Peru2014","Peru2015","Peru2016" ) {
replace w_mammogram_age = "50-69" if country_year=="`y'"
}
